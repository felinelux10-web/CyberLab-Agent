...
from lab_v4.awareness.scanner import scan_file, scan_directory
from lab_v4.awareness.model_builder import build_model, get_file_context
...
class ContextStore:
    ...
    def refresh_directory(self, directory: str) -> dict:
