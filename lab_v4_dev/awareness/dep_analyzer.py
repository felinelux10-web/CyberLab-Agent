...
def build_dependency_graph(directory: str | None, db: Database) -> dict:
    ...
    for root, dirs, files in os.walk(directory):
        dirs[:] = [d for d in dirs if d not in ["__pycache__", "archives", "cache", "stable", "releases", "project_indices", "workspace", "archive"]]
        for f in files:
            if f.endswith(".py"):
